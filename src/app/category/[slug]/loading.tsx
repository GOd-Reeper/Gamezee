  ...
  return (
    <div className="animate-pulse">
      ...
      <section className="bg-gradient-to-r from-primary-700 to-primary-900 py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="h-6 w-full bg-white/20 rounded mb-4"></div>
      ...
      <section className="bg-gray-50 dark:bg-gray-800 py-16">
        <div className="container mx-auto px-4">
          <div className="h-8 w-64 bg-gray-200 dark:bg-gray-700 rounded mx-auto mb-8"></div>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {[...Array(5)].map((_, i) => (
              <div key={i} className="bg-white dark:bg-gray-700 rounded-lg p-4 text-center">
                <div className="h-6 w-24 bg-gray-200 dark:bg-gray-600 rounded mx-auto"></div>
              </div>
            ))}
          </div>
        </div>
